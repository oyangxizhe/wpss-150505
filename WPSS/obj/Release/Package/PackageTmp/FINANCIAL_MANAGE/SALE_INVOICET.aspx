<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SALE_INVOICET.aspx.cs" Inherits="WPSS.FINANCIAL_MANAGE.SALE_INVOICET" %>
...
<div class ="c13101905">
  ...
  <div id="i15013001" class ="c13110501">
   ...
   <span class="c13110511" id ="Span6">
    ...
    <asp:LinkButton ID="btnReconcile" runat="server" onclick="btnReconcile_Click" CssClass ="">产生应收账款作业</asp:LinkButton>
    </span> 
   </div>
...
<span  class ="c13102102"><asp:Label ID="prompt" runat="server"  ForeColor="#f80707"></asp:Label></span>
     ...
     <div class="c15013001" id ="Div36">
      ...
      <span style="color :#990033">
         (1.同一个客户只需从选中行的第一行输入发票号码 发票未税 发票税额 发票含税即可) 
        </span>
</div>
     ...
     <div class="c15020401" id ="Div7">
      <span style="color :#990033"> (2.若选中项的销货单存在销退 且未收款扣账 则此销退单将一并发放到客户收款作业 
         3.选择经手人点经手人文本框 4.只有结案(已出货)的订单才在此显示)</span>
</div>
</div>
...
<div id="i14073101" class ="c15012901">
            <asp:GridView ID="GridView1" runat="server" 
                ...
                <ItemTemplate >
                 <asp:TextBox ID="TextBox18" runat="server"  Text='<%#Eval ("客户名称") %>' CssClass ="c14070203"  ></asp:TextBox>                     
                </ItemTemplate>
          <HeaderStyle Width="4%" />
                 <ItemStyle Width="4%"/>
            </asp:TemplateField>
         <asp:TemplateField HeaderText="订单号">
                <ItemTemplate >
                 <asp:TextBox ID="TextBox1" runat="server"  Text='<%#Eval ("订单号") %>' CssClass ="c14070203" ></asp:TextBox>                     
                </ItemTemplate>
               <HeaderStyle Width="4%" />
                 <ItemStyle Width="4%"  />
            </asp:TemplateField>
            ...
            <asp:TemplateField HeaderText="销货单号">
                <ItemTemplate >
                 <asp:TextBox ID="TextBox3" runat="server"  Text='<%#Eval ("销货单号") %>' CssClass ="c14070203" ></asp:TextBox>                     
                </ItemTemplate>
               <HeaderStyle Width="4%" />
                 <ItemStyle Width="4%"  />
            </asp:TemplateField>
              ...
              <HeaderStyle Width="4%" />
                ...
                <ItemTemplate >
                 <asp:TextBox ID="TextBox5" runat="server" Text='<%#Eval ("累计销货数量") %>' CssClass ="c14071615" ></asp:TextBox>                     
                </ItemTemplate>
                 <HeaderStyle Width="2%" />
                 <ItemStyle Width="2%"/>
            </asp:TemplateField>
           ...
           <asp:TemplateField HeaderText="料号">
              ...
              <HeaderStyle Width="4%" />
                ...
                <ItemTemplate >
                 <asp:TextBox ID="TextBox6" runat="server"  Text='<%#Eval ("销售单位") %>'  CssClass ="c14071615"></asp:TextBox>      
         ...
         <HeaderStyle Width="2%" />
                ...
                <ItemTemplate >
                 <asp:TextBox ID="TextBox19" runat="server"  Text='<%#Eval ("订单数量") %>'   CssClass ="c14071608"></asp:TextBox>                     
                </ItemTemplate>
                 <HeaderStyle Width="2%" />
                 <ItemStyle Width="2%" />
            </asp:TemplateField>
      ...
      <script type ="text/javascript" >
          ...
          function f13100202(obj, obj1) {
              var dlgResult;
              if (obj == "Text2") {
                  dlgResult = window.showModalDialog("../SALEManage/Supplierinfo.aspx", window, "dialogWidth:970px; dialogHeight:490px; status:0");
              ...
              dlgResult = window.showModalDialog("../BaseInfo/Wareinfo.aspx?CUID=" + document.getElementById("Text2").value + "&nature=SALE_det", window, "dialogWidth:970px; dialogHeight:490px; status:0");
              ...
              dlgResult = window.showModalDialog("../BaseInfo/unit.aspx?wareid=" + document.getElementById("wareid").value + "&nature=SALE_det", window, "dialogWidth:970px; dialogHeight:490px; status:0");
                  if (dlgResult != undefined) {
