<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RECEIVABLES_ORDERT.aspx.cs" Inherits="WPSS.FINANCIAL_MANAGE.RECEIVABLES_ORDERT" %>
     ...
     <div class="c13122401" id ="Div109">
      ...
      <script type ="text/javascript" >
          ...
          function f13100202(obj, obj1) {
              var dlgResult;
              if (obj == "Text2") {
                  dlgResult = window.showModalDialog("../financial_manage/receivables.aspx", window, "dialogWidth:970px; dialogHeight:490px; status:0;");
