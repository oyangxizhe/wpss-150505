<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="StorageInfo.aspx.cs" Inherits="WPSS.StockManage.StorageInfo" %>
...
<span  class ="c13102102"><asp:Label ID="prompt" runat="server"  ForeColor="#f80707"></asp:Label></span>
             ...
             <div >
               ...
               <asp:GridView ID="GridView1" runat="server" Width="75%" 
                   ...
                   <ItemTemplate>
         <a href ="javascript:f13100302('<%#Eval ("StorageID") %>','<%#Eval ("StorageName") %>')">
                       选取</a>
                   </ItemTemplate>
             ...
             <asp:TemplateField HeaderText="仓库代码">
                <ItemTemplate >
                    <asp:LinkButton ID="LinkButton1" runat="server" CommandName="Select" 
                        Text='<%# Bind("StorageID") %>'></asp:LinkButton>                     
                </ItemTemplate>
                 <HeaderStyle Width="80px" />
                 <ItemStyle Width="80px"  ForeColor="#595d5a"/>
            </asp:TemplateField>   
                         
                          <asp:BoundField DataField="StorageName" HeaderText="仓库名称" >
