<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CustomerInfo.aspx.cs" Inherits="WPSS.SellManage.CustomerInfo" %>
...
<span  class ="c13102102"><asp:Label ID="prompt" runat="server"  ForeColor="#f80707"></asp:Label></span>
             ...
             <div >
               ...
               <asp:GridView ID="GridView1" runat="server" Width="85%" 
                   ...
                   <ItemTemplate>
         <a href ="javascript:f13100302('<%#Eval ("CUID") %>','<%#Eval ("CName") %>','<%#Eval ("ADDRESS") %>','<%#Eval ("CONTACT") %>','<%#Eval ("PHONE") %>')">
                       选取</a>
                   </ItemTemplate>
             ...
             <asp:TemplateField HeaderText="客户代码">
                <ItemTemplate >
                 ...
                 <ItemStyle Width="60px"  ForeColor="#595d5a"/>
                    ...
                    <asp:BoundField DataField="PAYMENT" HeaderText="收款方式" >
                              <ItemStyle Width="100px"  ForeColor="#595d5a"/>
                                    <HeaderStyle Width="100px" HorizontalAlign="Center" />
                          </asp:BoundField>
                       <asp:BoundField DataField="PAYMENT_CLAUSE" HeaderText="收款条件" >
                              <ItemStyle Width="100px"  ForeColor="#595d5a"/>
                                    <HeaderStyle Width="100px" HorizontalAlign="Center" />
                          </asp:BoundField>
