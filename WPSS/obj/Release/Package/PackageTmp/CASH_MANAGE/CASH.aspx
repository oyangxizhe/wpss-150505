<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CASH.aspx.cs" Inherits="WPSS.CASH_MANAGE.CASH" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>库存现金账户信息维护</title>
...
<span  class ="c13102102"><asp:Label ID="prompt" runat="server"  ForeColor="#f80707"></asp:Label></span>
               ...
               <asp:GridView ID="GridView1" runat="server" 
                   ...
                   <ItemTemplate>
         <a href ="javascript:f13100302('<%#Eval ("CSID") %>','<%#Eval ("USER_GROUP") %>');">选取</a>
                   </ItemTemplate>
              ...
              <asp:TemplateField HeaderText="删除" >
               ...
               <asp:TemplateField HeaderText="账户编号">
                <ItemTemplate >
                    <asp:LinkButton ID="LinkButton1" runat="server" CommandName="Select" 
                        Text='<%# Bind("CSID") %>'></asp:LinkButton>                     
                </ItemTemplate>
          ...
          <asp:BoundField DataField="USER_GROUP" HeaderText="账户名" >
                             ...
                             <asp:BoundField DataField="CASH" HeaderText="开卡金额" >
                              <ItemStyle Width="80px"  ForeColor="#595d5a"/>
                                    <HeaderStyle Width="80px" HorizontalAlign="Center" />
                          </asp:BoundField>
