<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SupplierInfo.aspx.cs" Inherits="WPSS.PurchaseManage.SupplierInfo" %>
...
<span  class ="c13102102"><asp:Label ID="prompt" runat="server"  ForeColor="#f80707"></asp:Label></span>
             ...
             <div >
               ...
               <asp:GridView ID="GridView1" runat="server" 
                   ...
                   <ItemTemplate>
         <a href ="javascript:f13100302('<%#Eval ("SUID") %>','<%#Eval ("SName") %>','<%#Eval ("ADDRESS") %>','<%#Eval ("CONTACT") %>','<%#Eval ("PHONE") %>')">
                       选取</a>
                   </ItemTemplate>
                 ...
                 <ItemStyle Width="80px"  ForeColor="#595d5a"/>
                     ...
                     <asp:BoundField DataField="PAYMENT" HeaderText="付款方式" >
                              <ItemStyle Width="100px"  ForeColor="#595d5a"/>
                                ...
                                <asp:BoundField DataField="PAYMENT_CLAUSE" HeaderText="付款条件" >
                              <ItemStyle Width="100px"  ForeColor="#595d5a"/>
                                    <HeaderStyle Width="100px" HorizontalAlign="Center" />
                          </asp:BoundField>
