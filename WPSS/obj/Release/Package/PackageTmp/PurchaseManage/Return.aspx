<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Return.aspx.cs" Inherits="WPSS.PurchaseManage.Return" %>
...
<div class ="c13110501">
   ...
   <span class="c13110511" id ="Span3">
           <asp:Label ID="Label1" runat="server" Text="Label">(新增)</asp:Label>
          </span>
...
<span id="i13052904"  class ="c13110505"  >
  ...
  <input id="EndDate" type="text" runat="server" onclick ="f13100202('EndDate')" class ="c14111902" /></div>
   ...
   <span class="c13110511" id ="Span4">
              <asp:Label ID="Label2" runat="server" Text="Label">(搜索)</asp:Label>
              </span>
       </div>
    </div>
...
<span  class ="c13102102"><asp:Label ID="prompt" runat="server"  ForeColor="#f80707"></asp:Label></span>
               ...
               <asp:GridView ID="GridView1" runat="server" Width="80%" 
                   ...
                   <ItemTemplate>
         <a href ="javascript:f13100302('<%#Eval ("REID") %>');">选取</a>
                   </ItemTemplate>
             ...
             <asp:TemplateField HeaderText="退货单号">
                <ItemTemplate >
                    <asp:LinkButton ID="LinkButton1" runat="server" CommandName="Select" 
                        Text='<%# Bind("REID") %>'></asp:LinkButton>                     
                </ItemTemplate>
                 <HeaderStyle Width="60px" />
                 <ItemStyle Width="60px"  ForeColor="#595d5a"/>
            </asp:TemplateField> 
                 <asp:BoundField DataField="PUID" HeaderText="采购单号" >
                              ...
                              <ItemStyle Width="200px"  ForeColor="#595d5a"/>
                                 ...
                                 <asp:BoundField DataField="Return_DATE" HeaderText="退货日期"
                                 DataFormatString="{0:yyyy-MM-dd}" >
                              <ItemStyle Width="100px"  ForeColor="#595d5a"/>
                                    <HeaderStyle Width="100px" HorizontalAlign="Center" />
                          </asp:BoundField>
                             <asp:BoundField DataField="Return_ID" HeaderText="退货员" >
                              <ItemStyle Width="100px"  ForeColor="#595d5a"/>
                                    <HeaderStyle Width="100px" HorizontalAlign="Center" />
                          </asp:BoundField>
