<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LEND.aspx.cs" Inherits="WPSS.LEASE_MANAGE.LEND" %>
...
<span  class ="c13102102"><asp:Label ID="prompt" runat="server"  ForeColor="#f80707"></asp:Label></span>
         ...
         <asp:TemplateField HeaderText="选取">
                   <ItemTemplate>
         <a href ="javascript:f13100302('<%#Eval ("借出单号") %>','<%#Eval ("客户ID或供应商ID") %>','<%#Eval ("客户或供应商") %>','<%#Eval ("客户电话或供应商电话") %>')">
                       选取</a>
                   </ItemTemplate>
             ...
             <asp:TemplateField HeaderText="借出单号">
                <ItemTemplate >
                    <asp:LinkButton ID="LinkButton1" runat="server" CommandName="Select" 
                        Text='<%# Bind("借出单号") %>'></asp:LinkButton>                     
                </ItemTemplate>
