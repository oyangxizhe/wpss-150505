<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WareInfo.aspx.cs" Inherits="WPSS.BaseInfo.WareInfo" %>
  ...
  <input id="EndDate" type="text" runat="server"  onclick ="f13100202('EndDate')" class ="c14111902" /></div>
   ...
   <span class="c13110505" id ="Span4">
    ...
    <div class ="c13112601">
     ...
     '<%#Eval ("CWAREID") %>','<%#Eval ("CNAME") %>','<%#Eval ("SELLUNITPRICE") %>','<%#Eval ("SPEC") %>','<%#Eval ("REMARK") %>','<%#Eval ("UNIT") %>')">
                       选取</a>
                   </ItemTemplate>
...
<script type="text/javascript" language="javascript">
    var arr1 = new Array();
    var arr2 = new Array();
    function f13100302(obj, obj1, obj2, obj3,obj4,obj5,obj6,obj7,obj8) {
