<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CompanyInfoX.aspx.cs" Inherits="WPSS.BaseInfo.CompanyInfoX" %>
...
<span  class ="c13102102"><asp:Label ID="prompt" runat="server"  ForeColor="#f80707"></asp:Label></span>
             ...
             <div >
               ...
               <asp:GridView ID="GridView1" runat="server" Width="77%" 
                    AllowPaging="True" 
                   ...
                   <ItemTemplate>
         <a href ="javascript:f13100302('<%#Eval ("COKEY") %>','<%#Eval ("CONAME") %>','<%#Eval ("CONTACT") %>','<%#Eval ("PHONE") %>')">
                       选取</a>
                   </ItemTemplate>
...
<script type="text/javascript" language="javascript">
    function f13100302(obj, obj1, obj2,obj3) {
