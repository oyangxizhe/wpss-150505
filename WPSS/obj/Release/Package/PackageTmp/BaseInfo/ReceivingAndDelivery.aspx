<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ReceivingAndDelivery.aspx.cs" Inherits="WPSS.BaseInfo.ReceivingAndDelivery" %>
...
<span  class ="c13102102"><asp:Label ID="prompt" runat="server"  ForeColor="#f80707"></asp:Label></span>
             ...
             <div >
               ...
               <asp:GridView ID="GridView1" runat="server" 
                   ...
                   <ItemTemplate>
         <a href ="javascript:f13100302('<%#Eval ("RDID") %>','<%#Eval ("CONAME") %>','<%#Eval ("CONTACT") %>','<%#Eval ("PHONE") %>','<%#Eval ("ADDRESS") %>')">
                       选取</a>
                   </ItemTemplate>
             ...
             <asp:TemplateField HeaderText="地址代码">
                <ItemTemplate >
                    <asp:LinkButton ID="LinkButton1" runat="server" CommandName="Select" 
                        Text='<%# Bind("RDID") %>'></asp:LinkButton>                     
                </ItemTemplate>
                 <HeaderStyle Width="80px" />
                 <ItemStyle Width="80px"  ForeColor="#595d5a"/>
            </asp:TemplateField>   
                         
                          <asp:BoundField DataField="CONAME" HeaderText="公司名称" >
