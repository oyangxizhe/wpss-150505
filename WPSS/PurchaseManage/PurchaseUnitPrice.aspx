<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PurchaseUnitPrice.aspx.cs" Inherits="WPSS.PurchaseManage.PurchaseUnitPrice" %>
...
<span  class ="c13102102"><asp:Label ID="prompt" runat="server"  ForeColor="#f80707"></asp:Label></span>
             ...
             <asp:BoundField DataField="CO_WAREID" HeaderText="料号" >
                    ...
                    <asp:BoundField DataField="CWAREID" HeaderText="客户料号" >
                           ...
                           <asp:BoundField DataField="PURCHASEUNITPRICE" HeaderText="采购单价" >
                              <ItemStyle Width="60px" ForeColor="#595d5a" />
                                    <HeaderStyle HorizontalAlign="Center" Width="60px" />
                          </asp:BoundField>
                              <asp:BoundField DataField="SNAME" HeaderText="供应商名称" >
                              <ItemStyle Width="240px" ForeColor="#595d5a" />
