<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PurchaseUnitPriceT.aspx.cs" Inherits="WPSS.PurchaseManage.PurchaseUnitPriceT" %>
...
<span  class ="c13102102"><asp:Label ID="prompt" runat="server"  ForeColor="#f80707"></asp:Label></span>
      ...
      <div class="c13101903" id ="Div1">
          代码</div>
     <div class="c13102802" id ="Div3">
<input id="Text1" type="text"  runat="server"   readonly ="readonly" class="c13102103"/> 
         </div>
                 <div class="c13101903" id ="Div12">
                     ID</div>
     <div class="c13102802" id ="Div13">
   <input id="Text2" type="text"    runat ="server" class ="c13122503" /> 
        <span style =" margin-left :5px"> <a  href="javascript:f13100202('Text2');">选择</a></span> 
         </div>
                  <div class="c13101903" id ="Div11">
                     料号</div>
     
  <div class="c13122505" id ="Div14">
   <input id="Text3" type="text"  runat ="server" class ="c13102103" /> </div>
        <div class="c13101903" id ="Div7">
          品名</div>
     <div class="c14120501" id ="Div8">
<input id="Text4" type="text"  runat="server"   readonly ="readonly" class="c13102103"/> 
         </div>
           </div>
           <div class ="c13101902">
              ...
              客户料号</div>
     <div class="c13102802" id ="Div19">
   <input id="Text5" type="text"    runat ="server" class ="c13102103" /> 
     </div>
                  <div class="c13101903" id ="Div20">
                      供应商</div>
     
  <div class="c13122505" id ="Div22">
   <input id="Text6" type="text"  runat ="server" class ="c13122503" /> 
      <span style =" margin-left :5px"> <a  href="javascript:f13100202('Text6');">选择</a></span>
           </div>
                            <div class="c13101903" id ="Div16">
                     采购单价</div>
     <div class="c13102802" id ="Div17">
   <input id="Text7" type="text"    runat ="server" class ="c13122503" /> 
         <asp:RequiredFieldValidator ID="RequiredFieldValidator2" ControlToValidate="Text7" Text="必填" runat="server" /></div>
<div class ="c13102802"><span style="color :#990033">(单价为未税单价)</span></div>
           </div> 
     ...
     <asp:GridView ID="GridView1" runat="server" Width="58%" 
      ...
      <script type ="text/javascript" >
          ...
          function f13100202(obj) {
              var dlgResult;
              if (obj == "Text2") {
                  dlgResult = window.showModalDialog("../baseinfo/wareinfo.aspx", window, "dialogWidth:960px; dialogHeight:480px; status:0");
