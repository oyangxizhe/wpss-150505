<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PurchaseGode.aspx.cs" Inherits="WPSS.PurchaseManage.PurchaseGode" %>
...
<span  class ="c13102102"><asp:Label ID="prompt" runat="server"  ForeColor="#f80707"></asp:Label></span>
               ...
               <asp:GridView ID="GridView1" runat="server" Width="98%" 
                   ...
                   <ItemTemplate>
         <a href ="javascript:f13100302('<%#Eval ("PGID") %>');">选取</a>
                   </ItemTemplate>
                            ...
                            <asp:BoundField DataField="PURCHASESTATUS_MST" HeaderText="状态" >
                             ...
                             <asp:BoundField DataField="WNAME" HeaderText="品名" >
                              <ItemStyle Width="200px" ForeColor="#595d5a" />
                                 ...
                                 <asp:BoundField DataField="GODEDATE" HeaderText="入库日期"
                                 DataFormatString="{0:yyyy-MM-dd}" >
                              <ItemStyle Width="100px"  ForeColor="#595d5a"/>
                                    <HeaderStyle Width="100px" HorizontalAlign="Center" />
                          </asp:BoundField>
                             <asp:BoundField DataField="GODER" HeaderText="入库员" >
                              <ItemStyle Width="100px"  ForeColor="#595d5a"/>
                                    <HeaderStyle Width="100px" HorizontalAlign="Center" />
                          </asp:BoundField>
