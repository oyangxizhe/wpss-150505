<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CompanyInfo.aspx.cs" Inherits="WPSS.BaseInfo.CompanyInfo" %>
...
<span  class ="c13102102"><asp:Label ID="prompt" runat="server"  ForeColor="#f80707"></asp:Label></span>
             ...
             <div >
               ...
               <asp:GridView ID="GridView1" runat="server"
                   ...
                   <ItemTemplate>
         <a href ="javascript:f13100302('<%#Eval ("COID") %>','<%#Eval ("CONTACT") %>','<%#Eval ("ADDRESS") %>')">
                       选取</a>
                   </ItemTemplate>
             ...
             <asp:TemplateField HeaderText="公司代码">
                <ItemTemplate >
                    <asp:LinkButton ID="LinkButton1" runat="server" CommandName="Select" 
                        Text='<%# Bind("COID") %>'></asp:LinkButton>                     
                </ItemTemplate>
