...
namespace WPSS.BaseInfo
{
    public partial class UNIT : System.Web.UI.Page
    {
        ...
        basec bc = new basec();
        protected string sql = @"SELECT A.UNIT AS UNIT,(SELECT ENAME FROM EMPLOYEEINFO
WHERE EMID=A.MAKERID ) AS MAKER,
A.MAKERID,A.DATE,A.YEAR,A.MONTH FROM UNIT A ";
        ...
        protected void select()
        {
            ...
            {
                showdata(@" where  A.UNIT like '%" + v1 + "%' AND A.DATE BETWEEN  '" + v6 + "'AND '" + v7 + "' ");
            }
 ...
 (SELECT USER_GROUP FROM USERINFO WHERE USID='" + USID + "'))";
        ...
        protected void nextpage()
        {
            ...
            GridView1.DataKeyNames = new string[] { "UNIT" };
            GridView1.DataBind();
        ...
        protected void GridView1_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            string v1 = bc.getOnlyString("SELECT UNID FROM UNIT WHERE UNIT='" + varID + "'");

            UNITT.IDO = v1;
            UNITT.ADD_OR_UPDATE = "UPDATE";
            string n1 = Request.Url.AbsoluteUri;
        ...
        protected void GridView1_RowDeleting(object sender, GridViewDeleteEventArgs e)
        {
            ...
            try
            {
                ...
                if (bc.exists("SELECT * FROM WAREINFO WHERE UNIT='" + id + "'"))
                {
                    hint.Value = "品号信息中已经存在此属性，不允许删除！";
                }
                else
                {
                    string strSql = "DELETE FROM UNIT WHERE UNIT='" + id + "'";
