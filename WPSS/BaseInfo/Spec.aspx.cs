...
namespace WPSS.BaseInfo
{
    public partial class Spec : System.Web.UI.Page
    {
        ...
        basec bc = new basec();
        protected string sql = @"SELECT A.SPEC AS SPEC,(SELECT ENAME FROM EMPLOYEEINFO
WHERE EMID=A.MAKERID ) AS MAKER,
A.MAKERID,A.DATE,A.YEAR,A.MONTH FROM Spec A ";
        ...
        protected void select()
        {
            ...
            {
                showdata(@" where  A.SPEC like '%" + v1 + "%' AND A.DATE BETWEEN  '" + v6 + "'AND '" + v7 + "' ");
            }
 ...
 (SELECT USER_GROUP FROM USERINFO WHERE USID='" + USID + "'))";
        ...
        protected void nextpage()
        {
            ...
            GridView1.DataKeyNames = new string[] { "SPEC" };
            GridView1.DataBind();
        ...
        protected void GridView1_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            string v1 = bc.getOnlyString("SELECT SCID FROM SPEC WHERE SPEC='"+varID +"'");

            WPSS.BaseInfo.SpecT.IDO = v1;
            SpecT.ADD_OR_UPDATE = "UPDATE";
            string n1 = Request.Url.AbsoluteUri;
            string n2 = n1.Substring(n1.Length - 16, 16);
            Response.Redirect("../baseinfo/SpecT.aspx"+n2);
        ...
        protected void GridView1_RowDeleting(object sender, GridViewDeleteEventArgs e)
        {
            ...
            if (bc.exists("SELECT * FROM WAREINFO WHERE SPEC='" + id + "'"))
            {
                hint.Value = "品号信息中已经存在此属性，不允许删除！";
            }
            else
            {
                string strSql = "DELETE FROM Spec WHERE SPEC='" + id + "'";
        ...
        {
            string var1 = bc.numYM(10, 4, "0001", "SELECT * FROM SPEC", "SCID", "SC");
            SpecT.IDO = var1;
            SpecT.ADD_OR_UPDATE = "ADD";
            string n1 = Request.Url.AbsoluteUri;
            string n2 = n1.Substring(n1.Length - 16, 16);
            Response.Redirect("../BaseInfo/SpecT.aspx"+n2);
        }
