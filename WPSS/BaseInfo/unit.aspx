<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UNIT.aspx.cs" Inherits="WPSS.BaseInfo.UNIT" %>
...
<span  class ="c13102102"><asp:Label ID="prompt" runat="server"  ForeColor="#f80707"></asp:Label></span>
               ...
               <asp:GridView ID="GridView1" runat="server" 
                   ...
                   <ItemTemplate>
         <a href ="javascript:f13100302('<%#Eval ("UNIT") %>');">选取</a>
                   </ItemTemplate>
