...
namespace WPSS.BaseInfo
{
    public partial class DEPART : System.Web.UI.Page
    {
        ...
        basec bc = new basec();
        protected string sql = @"SELECT A.DEPART AS DEPART,(SELECT ENAME FROM EMPLOYEEINFO
WHERE EMID=A.MAKERID ) AS MAKER,
A.MAKERID,A.DATE,A.YEAR,A.MONTH FROM DEPART A ";
        ...
        protected void select()
        {
            ...
            {
                showdata(@" where  A.DEPART like '%" + v1 + "%' AND A.DATE BETWEEN  '" + v6 + "'AND '" + v7 + "' ");
            }
            ...
            else
            {
                if (v1 == "")
                {
                    ...
                    showdata(@" where  A.DEPART like '%" + v1 + "%'");
 ...
 (SELECT USER_GROUP FROM USERINFO WHERE USID='" + USID + "'))";
        ...
        protected void nextpage()
        {
            ...
            GridView1.DataKeyNames = new string[] { "DEPART" };
            GridView1.DataBind();
        ...
        protected void GridView1_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            string v1 = bc.getOnlyString("SELECT DEID FROM DEPART WHERE DEPART='" + varID + "'");

            DEPARTT.IDO = v1;
            DEPARTT.ADD_OR_UPDATE = "UPDATE";
            string n1 = Request.Url.AbsoluteUri;
            string n2 = n1.Substring(n1.Length - 16, 16);
            Response.Redirect("../baseinfo/DEPARTt.aspx" + n2);
        ...
        protected void GridView1_RowDeleting(object sender, GridViewDeleteEventArgs e)
        {
            ...
            try
            {
                string id = GridView1.DataKeys[e.RowIndex][0].ToString();
                    ...
                    string strSql = "DELETE FROM DEPART WHERE DEPART='" + id + "'";
        ...
        {
            string var1 = bc.numYM(10, 4, "0001", "SELECT * FROM DEPART", "DEID", "DE");
            DEPARTT.IDO = var1;
            DEPARTT.ADD_OR_UPDATE = "ADD";
            string n1 = Request.Url.AbsoluteUri;
            string n2 = n1.Substring(n1.Length - 16, 16);
            Response.Redirect("../BaseInfo/DEPARTt.aspx" + n2);
        }
