<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CompanyInfoPS.aspx.cs" Inherits="WPSS.BaseInfo.CompanyInfoPS" %>
...
<span  class ="c13102102"><asp:Label ID="prompt" runat="server"  ForeColor="#f80707"></asp:Label></span>
             ...
             <div >
               ...
               <asp:GridView ID="GridView1" runat="server" 
                   ...
                   <ItemTemplate>
         <a href ="javascript:f13100302('<%#Eval ("CUKEY") %>','<%#Eval ("联系人") %>','<%#Eval ("联系电话") %>','<%#Eval ("地址") %>')">
                       选取</a>
                   </ItemTemplate>
