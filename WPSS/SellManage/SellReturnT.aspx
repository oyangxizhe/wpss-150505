<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SellReturnT.aspx.cs" Inherits="WPSS.SellManage.SellReturnT" %>
...
<div class ="c13111602" id="i13122801">
                  ...
                  <asp:GridView ID="GridView1" runat="server" 
                    ...
                    onrowdatabound="GridView1_RowDataBound" 
                        AutoGenerateColumns="False" PageSize="15" 
                           CssClass ="c13122701" onrowdeleting="GridView1_RowDeleting"
                   >
           ...
           <asp:TemplateField HeaderText="ID" >
               ...
               <asp:TemplateField HeaderText="品名">
                <ItemTemplate >
                 <asp:TextBox ID="TextBox3" runat="server" Text='<%#Eval ("品名") %>' ReadOnly ="true" CssClass="c14071609"></asp:TextBox>                     
                </ItemTemplate>
                 <HeaderStyle Width="3%" />
                 <ItemStyle Width="3%"  ForeColor="#595d5a"/>
            </asp:TemplateField> 
               ...
               <asp:TemplateField HeaderText="可销退数">
                <ItemTemplate >
                 <asp:TextBox ID="TextBox9" runat="server" Text='<%#Eval ("可销退数量") %>' ReadOnly ="true" CssClass ="c14071615" ></asp:TextBox>                     
                </ItemTemplate>
              <HeaderStyle Width="2%" />
                 <ItemStyle Width="2%"  />
            </asp:TemplateField> 
                ...
                <ItemTemplate >
                 <asp:TextBox ID="TextBox11" runat="server" Text='<%#Eval ("销退数量") %>'  CssClass ="c13112302"></asp:TextBox>                     
                </ItemTemplate>
               <HeaderStyle Width="2%" />
                 <ItemStyle Width="2%"  />
            </asp:TemplateField> 
                ...
                <ItemTemplate >
                 <asp:TextBox ID="TextBox12" runat="server" Text='<%#Eval ("仓库") %>'  CssClass="c14120504"></asp:TextBox>
               ...
               <HeaderStyle Width="3%" />
                ...
                <HeaderStyle Width="2%" />
                 <ItemStyle Width="2%"  />
                        ...
                        <asp:TemplateField HeaderText="本销退单累计销退">
                <ItemTemplate >
                 <asp:TextBox ID="TextBox15" runat="server" Text='<%#Eval ("本销退单累计销退数量") %>'   CssClass ="c14071615"></asp:TextBox>                     
                </ItemTemplate>
                     <HeaderStyle Width="3%" />
                 <ItemStyle Width="3%"  ForeColor="#595d5a"/>
            </asp:TemplateField> 
                ...
                <ItemTemplate >
                 ...
                 <ItemStyle Width="3%"  ForeColor="#595d5a"/>
                            ...
                            <asp:TemplateField HeaderText="累计销退未税" >
                <ItemTemplate >
                 <asp:TextBox ID="TextBox17" runat="server" Text=' <%#DataBinder.Eval(Container.DataItem, "累计销退未税金额", "{0:F2}")%>'  CssClass ="c14071615"></asp:TextBox>                     
                </ItemTemplate>
                  <HeaderStyle Width="4%" />
                 <ItemStyle Width="4%"  ForeColor="#595d5a"/>
            </asp:TemplateField> 
                       <asp:TemplateField HeaderText="累计销退税额">
                <ItemTemplate >
                 <asp:TextBox ID="TextBox18" runat="server" Text=' <%#DataBinder.Eval(Container.DataItem, "累计销退税额", "{0:F2}")%>'    CssClass ="c14071615"></asp:TextBox>                     
                </ItemTemplate>
                     <HeaderStyle Width="3%" />
                 <ItemStyle Width="3%"  ForeColor="#595d5a"/>
            </asp:TemplateField> 
                       <asp:TemplateField HeaderText="累计销退含税">
                <ItemTemplate >
                 <asp:TextBox ID="TextBox19" runat="server" Text=' <%#DataBinder.Eval(Container.DataItem, "累计销退含税金额", "{0:F2}")%>'   CssClass ="c14071615"></asp:TextBox>                     
                </ItemTemplate>
                    <HeaderStyle Width="4%" />
                 <ItemStyle Width="4%"  ForeColor="#595d5a"/>
            </asp:TemplateField> 
               <asp:TemplateField HeaderText="可销退未税" >
                <ItemTemplate >
                 <asp:TextBox ID="TextBox20" runat="server" Text=' <%#DataBinder.Eval(Container.DataItem, "可销退未税金额", "{0:F2}")%>'    CssClass ="c14071615"></asp:TextBox>                     
                </ItemTemplate>
                    <HeaderStyle Width="3%" />
                 <ItemStyle Width="3%"  ForeColor="#595d5a"/>
            </asp:TemplateField> 
                       <asp:TemplateField HeaderText="可销退税额">
                <ItemTemplate >
                 <asp:TextBox ID="TextBox21" runat="server" Text=' <%#DataBinder.Eval(Container.DataItem, "可销退税额", "{0:F2}")%>'  CssClass ="c14071615"></asp:TextBox>                     
                </ItemTemplate>
                  <HeaderStyle Width="3%" />
                 <ItemStyle Width="3%"  ForeColor="#595d5a"/>
            </asp:TemplateField> 
                       <asp:TemplateField HeaderText="可销退含税">
                <ItemTemplate >
                 <asp:TextBox ID="TextBox22" runat="server" Text=' <%#DataBinder.Eval(Container.DataItem, "可销退含税金额", "{0:F2}")%>'   CssClass ="c14071615"></asp:TextBox>                     
                </ItemTemplate>
                <HeaderStyle Width="3%" />
                 <ItemStyle Width="3%"  ForeColor="#595d5a"/>
            </asp:TemplateField> 
              ...
              <asp:TemplateField HeaderText="规格">
                <ItemTemplate >
                 <asp:TextBox ID="TextBox4" runat="server" Text='<%#Eval ("规格") %>' ReadOnly ="true" CssClass="c14071609"></asp:TextBox>                     
                </ItemTemplate>
                   <HeaderStyle Width="3%" />
                 <ItemStyle Width="3%"  ForeColor="#595d5a"/>
            </asp:TemplateField> 
        ...
        <asp:TemplateField HeaderText="客户料号">
              ...
              <HeaderStyle Width="2%" />
                ...
                <ItemTemplate >
                 ...
                 <asp:TemplateField HeaderText="累计销货数">
                <ItemTemplate >
                 <asp:TextBox ID="TextBox14" runat="server" Text='<%#Eval("累计销货数量")%>'  CssClass ="c14071615"></asp:TextBox>                     
                </ItemTemplate>
                  <HeaderStyle Width="3%" />
                 <ItemStyle Width="3%"  ForeColor="#595d5a"/>
            </asp:TemplateField> 
                ...
                <ItemTemplate >
                 <asp:TextBox ID="TextBox10" runat="server" Text='<%#Eval ("累计销退数量") %>'  CssClass ="c14071615" ></asp:TextBox>                     
                </ItemTemplate>
                <HeaderStyle Width="2%" />
                 <ItemStyle Width="2%"  />
            </asp:TemplateField>
   ...
   <input id="Text9" type="text"  runat ="server" class ="c13102908"  /> 
      ...
      <script type ="text/javascript" >
          ...
          function f13100202(obj, obj1) {
              var dlgResult;
              if (obj == "Text2") {
                  dlgResult = window.showModalDialog("../SellManage/order.aspx?emid=" + document.getElementById("emid").value  + "", window, "dialogWidth:970px; dialogHeight:490px; status:0");
