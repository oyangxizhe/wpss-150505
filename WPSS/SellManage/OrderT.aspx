...
<span style =" margin-left :5px;"><a  href="javascript:f13100202('Text10','');">选择 </a></span> 
...
<div class ="c13111602">
          ...
          <asp:GridView ID="GridView1" runat="server" 
           ...
           <asp:TemplateField HeaderText="ID" >
              ...
              <asp:TemplateField HeaderText="前置天数">
                <ItemTemplate >
                 <asp:TextBox ID="TextBox10" runat="server" Text='<%#Eval ("前置天数") %>' CssClass ="c14120503"></asp:TextBox>                     
                </ItemTemplate>
                   <HeaderStyle Width="3%" />
                 <ItemStyle Width="3%"  ForeColor="#595d5a"/>
            </asp:TemplateField> 
                ...
                <ItemTemplate >
                 <asp:TextBox ID="TextBox11" runat="server" Text='<%#Eval ("需求日期") %>'  CssClass ="c13120501" ></asp:TextBox>                     
                </ItemTemplate>
                <HeaderStyle Width="6%" />
                 <ItemStyle Width="6%"  ForeColor="#595d5a"/>
            </asp:TemplateField> 
                                     <asp:TemplateField HeaderText="加急否">
                <ItemTemplate >
       ...
       <asp:BoundField DataField="客户料号" HeaderText="客户料号" >
           ...
           <asp:BoundField DataField="未税金额" HeaderText="未税金额"    DataFormatString="{0:0.00}"  >
            ...
            <asp:BoundField DataField="含税金额" HeaderText="含税金额"   DataFormatString="{0:0.00}">
             ...
             <asp:BoundField DataField="加急否" HeaderText="加急否"   >
                              <ItemStyle Width="80px"  ForeColor="#595d5a" HorizontalAlign="Center" />
                                    <HeaderStyle Width="80px" HorizontalAlign="Center" />
                          </asp:BoundField>
