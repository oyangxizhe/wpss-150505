...
<input id="Text1" type="text"  runat="server"   readonly ="readonly" class="c13102103" /> 
 ...
 <input id="Text3" type="text"  runat ="server" class ="c13110901" /> 
        <span style =" margin-left :2px; margin-right :2px;"><a  href="javascript:f13100202('Text3','');">选择</a></span>
         </div>
 ...
 <input id="Text5" type="text"  runat ="server" class ="c13110901" /> 
        <span style =" margin-left :2px; margin-right :2px;"><a  href="javascript:f13100202('Text5','');">选择</a></span>
         </div>
           </div>
