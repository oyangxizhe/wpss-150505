<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UserInfo.aspx.cs" Inherits="WPSS.UserManage.UserInfo" %>
...
<span  class ="c13102102"><asp:Label ID="prompt" runat="server"  ForeColor="#f80707"></asp:Label></span>
               ...
               <asp:GridView ID="GridView1" runat="server" Width="65%" 
                   ...
                   <ItemTemplate>
         <a href ="javascript:f13100302('<%#Eval ("用户名") %>','<%#Eval ("姓名") %>','<%#Eval ("用户组") %>')">
                       选取</a>
                   </ItemTemplate>
                ...
                <ItemTemplate >
                 ...
                 <ItemStyle Width="60px"  ForeColor="#595d5a"/>
                          ...
                          <asp:BoundField DataField="用户名" HeaderText="用户名" >
                            ...
                            <asp:BoundField DataField="用户组" HeaderText="用户组" >
                              <ItemStyle Width="80px"  ForeColor="#595d5a"/>
                                    <HeaderStyle Width="80px" HorizontalAlign="Center" />
                          </asp:BoundField>
