<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PAYMENT_ORDER.aspx.cs" Inherits="WPSS.FINANCIAL_MANAGE.PAYMENT_ORDER" %>
...
<span  class ="c13102102"><asp:Label ID="prompt" runat="server"  ForeColor="#f80707"></asp:Label></span>
             ...
             <div >
               ...
               <asp:GridView ID="GridView1" runat="server" 
                   ...
                   <ItemTemplate>
         <a href ="javascript:f13100302('<%#Eval ("付款单号") %>','<%#Eval ("付款金额") %>')">
                       选取</a>
                   </ItemTemplate>
             ...
             <asp:TemplateField HeaderText="付款单号">
                <ItemTemplate >
                    <asp:LinkButton ID="LinkButton1" runat="server" CommandName="Select"  
                        Text='<%# Bind("付款单号") %>'></asp:LinkButton>                     
                </ItemTemplate>
                 <HeaderStyle Width="100px" />
                 <ItemStyle Width="100px"  ForeColor="#595d5a"/>
            </asp:TemplateField>   
                    
                            <asp:BoundField DataField="请款单号" HeaderText="请款单号" >
                    ...
                    <ItemStyle Width="150px" ForeColor="#595d5a" />
                            ...
                            <asp:BoundField DataField="实际请款金额" HeaderText="实际请款" >
                     <ItemStyle Width="80px"  ForeColor="#595d5a"  HorizontalAlign="Right" />
                                    <HeaderStyle Width="80px" HorizontalAlign="Right" />
                          </asp:BoundField>
                            <asp:BoundField DataField="付款金额" HeaderText="付款金额" >
                         <ItemStyle Width="80px"  ForeColor="#595d5a"  HorizontalAlign="Right" />
                                    <HeaderStyle Width="80px" HorizontalAlign="Right" />
                          </asp:BoundField>
                        
                            <asp:BoundField DataField="累计付款金额" HeaderText="累计付款" >
                       <ItemStyle Width="80px"  ForeColor="#595d5a"  HorizontalAlign="Right" />
                                    <HeaderStyle Width="80px" HorizontalAlign="Right" />
                          </asp:BoundField>
                           <asp:BoundField DataField="未付款金额" HeaderText="未付款" >
                           <ItemStyle Width="80px"  ForeColor="#595d5a"  HorizontalAlign="Right" />
                                    <HeaderStyle Width="80px" HorizontalAlign="Right" />
                          </asp:BoundField>
