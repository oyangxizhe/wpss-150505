<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RECEIVABLES.aspx.cs" Inherits="WPSS.FINANCIAL_MANAGE.RECEIVABLES" %>
...
<span  class ="c13102102">
             ...
             <div >
               ...
               <asp:GridView ID="GridView1" runat="server" 
                   ...
                   <ItemTemplate>
         <a href ="javascript:f13100302('<%#Eval ("应收单号") %>','<%#Eval ("客户名称") %>','<%#Eval ("发票号码") %>', '<%#Eval ("发票含税金额") %>',
         '<%#Eval ("预收款单号") %>', '<%#Eval ("预收款金额") %>','<%#Eval ("扣款项目") %>','<%#Eval ("扣款金额") %>','<%#Eval ("实际应收金额") %>',
          '<%#Eval ("累计收款金额") %>', '<%#Eval ("未收款金额") %>')">
                       选取</a>
                   </ItemTemplate>
             ...
             <asp:TemplateField HeaderText="应收单号">
                <ItemTemplate >
                    <asp:LinkButton ID="LinkButton1" runat="server" CommandName="Select"  
                        Text='<%# Bind("应收单号") %>'></asp:LinkButton>                     
                </ItemTemplate>
                 <HeaderStyle Width="80px" />
                 <ItemStyle Width="80px"  ForeColor="#595d5a"/>
            </asp:TemplateField>   
                    
                          <asp:BoundField DataField="客户名称" HeaderText="客户" >
                    ...
                    <ItemStyle Width="100px" ForeColor="#595d5a" />
                             ...
                             <ItemStyle Width="80px"  ForeColor="#595d5a"  HorizontalAlign="Right" />
                              ...
                              <asp:BoundField DataField="应收日期" HeaderText="应收日期" >
                              <ItemStyle Width="100px" ForeColor="#595d5a" />
                                    <HeaderStyle HorizontalAlign="Center" Width="100px" />
                          </asp:BoundField>
                     
                             <asp:BoundField DataField="应收人" HeaderText="应收人" >
                              <ItemStyle Width="100px" ForeColor="#595d5a" />
                                    <HeaderStyle HorizontalAlign="Center" Width="100px" />
                          </asp:BoundField>
