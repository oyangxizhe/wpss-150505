<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RECEIVABLES_ORDER.aspx.cs" Inherits="WPSS.FINANCIAL_MANAGE.RECEIVABLES_ORDER" %>
...
<span id="i13052904"  class ="c13110505"  >
     ...
     <div class="c14111903" id ="Div12">
            <input id="Text4" type="text"  runat ="server" class="c14111902" /></div>
...
<span  class ="c13102102"><asp:Label ID="prompt" runat="server"  ForeColor="#f80707"></asp:Label></span>
             ...
             <div >
               ...
               <asp:GridView ID="GridView1" runat="server" 
                   ...
                   <ItemTemplate>
         <a href ="javascript:f13100302('<%#Eval ("收款单号") %>','<%#Eval ("收款金额") %>')">
                       选取</a>
                   </ItemTemplate>
             ...
             <asp:TemplateField HeaderText="收款单号">
                <ItemTemplate >
                    <asp:LinkButton ID="LinkButton1" runat="server" CommandName="Select"  
                        Text='<%# Bind("收款单号") %>'></asp:LinkButton>                     
                </ItemTemplate>
                 <HeaderStyle Width="100px" />
                 <ItemStyle Width="100px"  ForeColor="#595d5a"/>
            </asp:TemplateField>   
                    
                            <asp:BoundField DataField="应收单号" HeaderText="应收单号" >
                    ...
                    <ItemStyle Width="150px" ForeColor="#595d5a" />
                            ...
                            <asp:BoundField DataField="实际应收金额" HeaderText="实际应收" >
                     <ItemStyle Width="80px"  ForeColor="#595d5a"  HorizontalAlign="Right" />
                                    <HeaderStyle Width="80px" HorizontalAlign="Right" />
                          </asp:BoundField>
                            <asp:BoundField DataField="收款金额" HeaderText="收款金额" >
                         <ItemStyle Width="80px"  ForeColor="#595d5a"  HorizontalAlign="Right" />
                                    <HeaderStyle Width="80px" HorizontalAlign="Right" />
                          </asp:BoundField>
                        
                            <asp:BoundField DataField="累计收款金额" HeaderText="累计收款" >
                       <ItemStyle Width="80px"  ForeColor="#595d5a"  HorizontalAlign="Right" />
                                    <HeaderStyle Width="80px" HorizontalAlign="Right" />
                          </asp:BoundField>
                           <asp:BoundField DataField="未收款金额" HeaderText="未收款" >
                           <ItemStyle Width="80px"  ForeColor="#595d5a"  HorizontalAlign="Right" />
                                    <HeaderStyle Width="80px" HorizontalAlign="Right" />
                          </asp:BoundField>
