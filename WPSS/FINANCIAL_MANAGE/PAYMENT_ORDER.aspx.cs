    ...
    public partial class PAYMENT_ORDER : System.Web.UI.Page
    {
        ...
        protected void select()
        {
            ...
            string sql = "付款单号 LIKE '%" + Text1.Value + "%' AND 发票号码 LIKE '%" + Text2.Value + "%' AND 供应商名称 LIKE '%" + Text3.Value +
                "%' AND 请款单号 LIKE '%" + Text4.Value + "%' ";
            DataTable dt = bc.GET_DT_TO_DV_TO_DT(cpayment_order .RETURN_DT (), "", sql);
            if (dt.Rows.Count > 0)
            {
        ...
        protected void showdata(string sqlo)
        {
            ...
            dt = bc.getdt(cpayment_order.sql + sqlo);
            if (dt.Rows.Count > 0)
            {
                x.Value = Convert.ToString(1);
        ...
        protected void nextpage()
        {
            ...
            GridView1.DataKeyNames = new string[] { "付款单号" };
            GridView1.DataBind();
        ...
        protected void GridView1_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            PAYMENT_ORDERT.IDO = varID;
            PAYMENT_ORDERT.ADD_OR_UPDATE = "UPDATE";
            string n1 = Request.Url.AbsoluteUri;
            string n2 = n1.Substring(n1.Length - 16, 16);
            Response.Redirect("../FINANCIAL_MANAGE/PAYMENT_ORDERT.aspx"+n2);
        ...
        protected void GridView1_RowDeleting(object sender, GridViewDeleteEventArgs e)
        {
            ...
            sql2 = "DELETE FROM PAYMENT_ORDER WHERE POID='" + id + "'";
            basec.getcoms(sql2);
        ...
        {
            hint.Value = "";
            PAYMENT_ORDERT.IDO = cpayment_order.GETID();
            PAYMENT_ORDERT.ADD_OR_UPDATE = "ADD";
            string n1 = Request.Url.AbsoluteUri;
            string n2 = n1.Substring(n1.Length - 16, 16);
            Response.Redirect("../FINANCIAL_MANAGE/PAYMENT_ORDERT.aspx"+n2);
        }
