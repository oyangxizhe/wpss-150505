...
<input id="Text1" type="text"  runat="server"   readonly ="readonly" class="c13102103"/> 
   ...
   <input id="Text2" type="text"  runat ="server" class ="c14031405"  /><asp:RequiredFieldValidator ID="RequiredFieldValidator2" ControlToValidate="Text2" Text="必填" runat="server" /></div>
