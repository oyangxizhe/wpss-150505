...
namespace WPSS.CASH_MANAGE
{
    public partial class CASH : System.Web.UI.Page
    {
        ...
        protected void select()
        {
            ...
            {
                showdata(@" where  B.USER_GROUP like '%" + v1 + "%' AND B.DATE BETWEEN  '" + v6 + "'AND '" + v7 + "' ");
            }
            ...
            else
            {
                if (v1 == "")
                {
                    ...
                    showdata(@" where  B.USER_GROUP like '%" + v1 + "%'");
        ...
        protected void showdata(string sqlo)
        {
            ...
            {
                sqlth = @" AND B.MAKERID IN (SELECT EMID FROM USERINFO A WHERE USER_GROUP IN 
 (SELECT USER_GROUP FROM USERINFO WHERE USID='" + USID + "'))";
            ...
            else
            {
                ...
                sqlth = " AND B.MAKERID='" + EMID + "'";

            }


            dt = bc.getdt(ccash.sql + sqlo + sqlth + sqlt);
            if (dt.Rows.Count > 0)
            {
        ...
        protected void nextpage()
        {
            ...
            GridView1.DataKeyNames = new string[] { "CSID" };
            GridView1.DataBind();
        ...
        protected void GridView1_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            WPSS.CASH_MANAGE.CASHT.IDO  = str[0];
            WPSS.CASH_MANAGE.CASHT.ADD_OR_UPDATE = "UPDATE";
            string n1 = Request.Url.AbsoluteUri;
            string n2 = n1.Substring(n1.Length - 16, 16);
            Response.Redirect("../cash_manage/casht.aspx" + n2);
        ...
        protected void GridView1_RowDeleting(object sender, GridViewDeleteEventArgs e)
        {
            ...
            sql = "DELETE CASH WHERE CSID='" + id + "'";
            string v1 = bc.getOnlyString("SELECT USER_GROUP FROM GODE WHERE GODEID='"+id+"'");
       
            if (bc.exists("SELECT * FROM CASH_ADD A LEFT JOIN GODE B ON A.CDID=B.GODEID WHERE B.USER_GROUP='" +v1+ "'"))
            {
                hint.Value = "该库存现金账户已经有冲值记录，不允许删除！";
            }
             else if (bc.JuageDeleteCASH_MoreThanStorageCASH(id,v1))
             {
                 hint.Value = bc.ErrowInfo;
             }
            else
        ...
        protected void btnAdd_Click(object sender, ImageClickEventArgs e)
        {
            ...
            CASHT.IDO = var1;
            WPSS.CASH_MANAGE.CASHT.ADD_OR_UPDATE = "ADD";
            string n1 = Request.Url.AbsoluteUri;
            string n2 = n1.Substring(n1.Length - 16, 16);
            Response.Redirect("../cash_manage/casht.aspx" + n2);
        }
