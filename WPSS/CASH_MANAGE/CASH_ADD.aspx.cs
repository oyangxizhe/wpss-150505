...
{
    public partial class CASH_ADD : System.Web.UI.Page
    {
 ...
 (SELECT USER_GROUP FROM USERINFO WHERE USID='" + USID + "'))";
            ...
            dt = bc.getdt(ccash_add.sql + sqlo + sqlth + sqlt);
            if (dt.Rows.Count > 0)
            {
        ...
        protected void nextpage()
        {
            ...
            GridView1.DataKeyNames = new string[] { "CDID" };
            GridView1.DataBind();
        ...
        protected void GridView1_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            WPSS.CASH_MANAGE.CASH_ADDT.IDO  = str[0];
            WPSS.CASH_MANAGE.CASH_ADDT.ADD_OR_UPDATE = "UPDATE";
            string n1 = Request.Url.AbsoluteUri;
            string n2 = n1.Substring(n1.Length - 16, 16);
            Response.Redirect("../cash_manage/cash_addt.aspx" + n2);
        ...
        protected void GridView1_RowDeleting(object sender, GridViewDeleteEventArgs e)
        {
            ...
            sql = "DELETE CASH_ADD WHERE CDID='" + id + "'";
            string v1 = bc.getOnlyString("SELECT USER_GROUP FROM GODE WHERE GODEID='" + id + "'");
            if (bc.JuageDeleteCASH_MoreThanStorageCASH(id, v1))
            {
                hint.Value = bc.ErrowInfo;
            }
            else
        ...
        protected void btnAdd_Click(object sender, ImageClickEventArgs e)
        {
            ...
            CASH_ADDT.IDO = ccash_add.RETURN_ID();
            WPSS.CASH_MANAGE.CASH_ADDT.ADD_OR_UPDATE = "ADD";
            string n1 = Request.Url.AbsoluteUri;
            string n2 = n1.Substring(n1.Length - 16, 16);
            Response.Redirect("../cash_manage/cash_addt.aspx" + n2);
        }
